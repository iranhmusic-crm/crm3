...
class m231113_162951_mha_rename_coupon_to_discount extends Migration
{
	...
	{
		$this->execute(<<<SQL
ALTER TABLE `tbl_M_H_A_Accounting_Discount`
...
SQL
		...
		///JSON
    $this->alterColumn('tbl_M_H_A_Accounting_Discount', 'dscTargetMemberGroupIDs', $this->json());
    $this->alterColumn('tbl_M_H_A_Accounting_Discount', 'dscTargetKanoonIDs', $this->json());
    $this->alterColumn('tbl_M_H_A_Accounting_Discount', 'dscTargetProductMhaTypes', $this->json());
	}
