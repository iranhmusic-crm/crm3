...
class m240816_120128_mha_convert_all_datetimes_to_timestamp extends Migration
{
...
SQL
		...
		$this->execute(<<<SQL
ALTER TABLE `tbl_MHA_Accounting_DiscountUsage`
...
SQL
		...
		$this->execute(<<<SQL
ALTER TABLE `tbl_MHA_Accounting_SaleableFile`
...
SQL
		...
		$this->execute(<<<SQL
ALTER TABLE `tbl_MHA_Accounting_Unit`
...
SQL
		...
		$this->execute(<<<SQL
ALTER TABLE `tbl_MHA_Accounting_UserAsset_File`
...
SQL
	...
	{
		echo "m240816_120128_mha_convert_all_datetimes_to_timestamp cannot be reverted.\n";
		return false;
	}
