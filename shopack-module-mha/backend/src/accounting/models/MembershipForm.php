...
class MembershipForm extends Model
{
    ...
    public static function getRenewalInfo($memberID, $printCard = true)
    {
        ...
        return [
            ...
            'cardPrintSaleableModel' => $cardPrintSaleableModel,
    ...
    public static function addToBasket(
        ...
        //get saleable info
        $info = self::getRenewalInfo(Yii::$app->user->id, $printCard);
    ...
    public static function getRenewalInfoForInvoice(
        ...
        if (empty($ofpID) == false) {
            ...
            if ((empty($memberID) == false) && ($memberID != $offlinePaymentModel->ofpOwnerUserID))
    ...
    private static function setVchStatusToWaitForPayment($voucherID)
    {
        ...
        $apiResponse = HttpHelper::callApi(
            'aaa/voucher/set-invoice-as-wait-for-payment',
