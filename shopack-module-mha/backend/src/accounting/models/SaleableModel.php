...
class SaleableModel extends MhaActiveRecord
{
    ...
    {
        $this->softdelete_RemovedStatus  = enuSaleableStatus::Removed;
        // $this->softdelete_StatusField    = 'slbStatus';
        $this->softdelete_RemovedAtField = 'slbRemovedAt';
        $this->softdelete_RemovedByField = 'slbRemovedBy';
    }
...
SQL;
    ...
    public static function ProcessVoucherItem($voucherID, $userid, $voucherItemdata)
    {
        ...
        if (in_array($userAssetModel->uasStatus, [
            enuUserAssetStatus::Active,
            enuUserAssetStatus::Pending
        ]))
            return true;
