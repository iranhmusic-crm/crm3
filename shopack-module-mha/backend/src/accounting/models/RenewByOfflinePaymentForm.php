...
*/
	...
	{
		if (($offlinePaymentModel = OfflinePaymentModel::findOne($this->ofpid)) === null)
      throw new NotFoundHttpException('The requested offline payment not exist.');

		$justForMe = $_GET['justForMe'] ?? false;
		if ($justForMe && ($offlinePaymentModel->ofpOwnerUserID != Yii::$app->user->id))
