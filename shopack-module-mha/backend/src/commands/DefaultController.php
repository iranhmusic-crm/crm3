...
-- BIRTHDAY:
0 15 30 45
cd /home2/iranhmus/domains/api.iranhmusic.ir/public_html; /usr/local/php-8.2/bin/php yii aaa/message/send-birthday-greetings 2>&1 >>logs/aaa_message_send-birthday-greetings.log



cd /home2/iranhmus/domains/api.iranhmusic.ir/public_html; /usr/local/php-8.2/bin/php yii aaa/default/new-keys 2>&1 >>logs/new-keys.log

cd /home2/iranhmus/domains/api.iranhmusic.ir/public_html; /usr/local/php-8.2/bin/php yii aaa/default/heartbeat 2>&1 >>logs/aaa-heartbeat.log
...
-- HEARTBEAT:
cd /home2/iranhmus/domains/api.iranhmusic.ir/public_html; /usr/local/php-8.2/bin/php yii mha/default/heartbeat 2>&1 >>logs/mha-heartbeat.log

-- check-accounts-expiration:
cd /home2/iranhmus/domains/api.iranhmusic.ir/public_html; /usr/local/php-8.2/bin/php yii mha/default/check-accounts-expiration 2>&1 >>logs/mha-check-accounts-expiration.log
