...
<div class='members-report-form'>
    ...
    $formNameLower = strtolower($formName);
		...
		$builder->fields([
			...
			['rptInputFields[mbrknnParams][' . enuBasicDefinitionType::Instrument . ']',
				'label' => 'ساز',
				'type' => FormBuilder::FIELD_WIDGET,
				'widget' => Select2::class,
				'widgetOptions' => [
			...
			['rptInputFields[mbrknnParams][' . enuBasicDefinitionType::Sing . ']',
				'label' => 'آواز',
				'type' => FormBuilder::FIELD_WIDGET,
				'widget' => Select2::class,
				'widgetOptions' => [
			...
			['rptInputFields[mbrknnParams][' . enuBasicDefinitionType::Research . ']',
				'label' => 'پژوهش',
				'type' => FormBuilder::FIELD_WIDGET,
				'widget' => Select2::class,
				'widgetOptions' => [
