...
class ReportModel extends RestClientActiveRecord
{
    ...
    public function outputFields()
    {
        ...
        return [
            ...
            'user.usrFirstName' => [
                'label' => Yii::t('aaa', 'First Name'),
                'format' => 'raw',
                'value' => function ($model, $key, $index, $widget) {
                    return Html::a($model['user']['usrFirstName'], ['/mha/member/view', 'id' => $model['mbrUserID']]);
                },
                'export' => function ($model) {
            ...
            'user.usrLastName' => [
                ...
                'format' => 'raw',
                'value' => function ($model, $key, $index, $widget) {
                    return Html::a($model['user']['usrLastName'], ['/mha/member/view', 'id' => $model['mbrUserID']]);
                },
                'export' => function ($model) {
            ...
            'user.usrLastName_en' => [
                'label' => Yii::t('aaa', 'Last Name (en)'),
                'format' => 'raw',
                'value' => function ($model, $key, $index, $widget) {
                    return Html::a($model['user']['usrLastName_en'], ['/mha/member/view', 'id' => $model['mbrUserID']]);
                },
                'export' => function ($model) {
                    return $model['user']['usrLastName_en'];
                },
            ],
