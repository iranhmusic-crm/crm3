...
class AssetManager extends \yii\web\AssetManager
{
	...
	public function init()
	{
		...
		$vendor_shopack_base_fe = realpath(Yii::getAlias('@vendor/shopack/yii2-base-frontend/src/assets'));

		$this->assetMap = [
			'bootstrap.css' => $hashCallback($bower_bootstrap) . '/dist/css/bootstrap.rtl.css',
			'bootstrap-dialog-bs4.css' => $hashCallback($vendor_shopack_base_fe) . '/css/bootstrap-dialog-bs4.rtl.css',
		];
