        ...
        <div class="user-panel mt-3 mb-4 pb-3 d-flex text-sm">
            ...
            <div class="info">
                ...
                <a class="d-block text-xs">
                    < ? = Yii::t('app', 'SideBarMenu.UserPanel.LoggedAt', Yii::$app->user->identity->created_at) ?>
                </a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            ...
            if (Yii::$app->user->can('menu.main')) {
                ...
                if (Yii::$app->user->can('site.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Dashboard'),
                ...
                if (Yii::$app->user->can('content.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Contents'),
                        'icon' => 'fa-file-alt',
                        'url' => ['/content/index'],
                        'active' => $active,
                    ];
                ...
                if (Yii::$app->user->can('customer.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Customers'),
                ...
                if (Yii::$app->user->can('gallery.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Galleries'),
                        'icon' => 'fa-images',
                        'url' => ['/gallery/index'],
                        'active' => $active,
                    ];
                ...
                $menuItems[] = [
                    'label' => Yii::t('app', 'SideBarMenu.Title.Main'),
                    'url' => '#',
                    'icon' => 'fa-home',
            ...
            if (Yii::$app->user->can('menu.report')) {
                ...
                if (Yii::$app->user->can('reports.customer-report.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Report.CustomerReport'),
                        'icon' => 'fa-user-friends',
                ...
                if (Yii::$app->user->can('reports.user-report.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Report.UserReport'),
                        'icon' => 'fa-user',
                ...
                $menuItems[] = [
                    'label' => Yii::t('app', 'SideBarMenu.Title.Reports'),
                    'url' => '#',
                    'icon' => 'fa-chart-pie',
                    'options' => ['class' => 'nav-item has-treeview ' . ($isOpen ? 'menu-open' : '')],
                    'items' => $subItems,
            ...
            if (Yii::$app->user->can('menu.system')) {
                ...
                if (Yii::$app->user->can('log.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Logs'),
                        'icon' => 'fa-history',
                        'url' => ['/log/index'],
                        'active' => $active,
                    ];
                ...
                if (Yii::$app->user->can('user.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Users'),
                        'icon' => 'fa-user',
                        'url' => ['/user/index'],
                        'active' => WebUtil::isActionActive(['/user/*']),
                    ];
                ...
                if (Yii::$app->user->can('group.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Groups'),
                        'icon' => 'fa-users',
                        'url' => ['/group/index'],
                        'active' => $active,
                    ];
                ...
                if (Yii::$app->user->can('permission.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Permissions'),
                        'icon' => 'fa-tags',
                ...
                if (Yii::$app->user->can('preferences.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Preferences'),
                        'icon' => 'fa-wrench',
                ...
                if (Yii::$app->user->can('profile.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Profile'),
                        'icon' => 'fa-id-badge',
                        'url' => ['/profile/index'],
                        'active' => $active,
                    ];
                ...
                if (Yii::$app->user->can('settings.index')) {
                    ...
                    $subItems[] = [
                        'label' => Yii::t('app', 'SideBarMenu.Item.Settings'),
                        'icon' => 'fa-cog',
                        'url' => ['/settings/index'],
                        'active' => $active,
                    ];
                ...
                $subItems[] = [
                    'label' => Yii::t('app', 'SideBarMenu.Item.Logout'),
                    'icon' => 'fa-sign-out-alt',
                    'url' => ['/site/logout']
                ];

                $menuItems[] = [
                    'label' => Yii::t('app', 'SideBarMenu.Title.System'),
                    'url' => '#',
                    'icon' => 'fa-cog',
                    'options' => ['class' => 'nav-item has-treeview ' . ($isOpen ? 'menu-open' : '')],
                    'items' => $subItems,
